						...
						<div className="register-card">
							...
							<Form onSubmit={handleSubmit} className="register-form" noValidate>
								<Form.Group className="form-group" controlId="regName">
									...
									/>
									{(touched.name || submitted) && errors.name && <div className="invalid-feedback">{errors.name}</div>}
								</Form.Group>
								...
								<Form.Group className="form-group" controlId="regEmail">
									...
									/>
									{(touched.email || submitted) && errors.email && <div className="invalid-feedback">{errors.email}</div>}
								</Form.Group>
								...
								<Form.Group className="form-group" controlId="regPhone">
									...
									/>
									{(touched.phone || submitted) && errors.phone && <div className="invalid-feedback">{errors.phone}</div>}
								</Form.Group>
								...
								<Form.Group className="form-group" controlId="regPassword">
									...
									<Form.Control
										...
										onChange={handleChange}
										onBlur={handleBlur}
										isInvalid={!!errors.password && (touched.password || submitted)}
									/>
									{(touched.password || submitted) && errors.password && <div className="invalid-feedback">{errors.password}</div>}
								</Form.Group>
